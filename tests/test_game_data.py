...
def test_survival_bunker_durability_penalty():
    ...
    bunker_info = {"years": 2, "durability": 10, "condition": "Зруйнований", "resources": "Критично"}

    alive_players = [
        {
            "name": "Doctor",
            "character": {"gender": "Чоловік", "age": 30, "health": "Здоровий", "fact": "", "profession": "Вірусолог"}
        },
        {
            "name": "Chemist",
            "character": {"gender": "Жінка", "age": 30, "health": "Здоровий", "fact": "", "profession": "Хімік"}
        }
    ]
